...
# Define the melody as a list of tuples (note, duration in ms)
melody = [
    ('E4', 300), ('D4', 300), ('C4', 300), ('D4', 300),
    ('E4', 300), ('E4', 300), ('E4', 600),
    ('D4', 300), ('D4', 300), ('D4', 600),
    ('E4', 300), ('G4', 300), ('G4', 600)
]

# Initialize PWM on a pin connected to the buzzer
buzzer = PWM(Pin(15))

def play_tone(note, duration):
    if note in NOTE_FREQUENCIES:
        buzzer.freq(NOTE_FREQUENCIES[note])
